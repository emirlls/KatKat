...
public static class KatKatHubConsts
{
    ...
    public static class EventNames
    {
        ...
        public const string P2PRequestCancelled = "ReceiveP2PRequestCancelled";
        ...
        public const string ResourceReservationApproved = "ReceiveResourceReservationApproved";
        public const string ResourceReservationRejected = "ReceiveResourceReservationRejected";
        public const string SosAlertReported = "ReceiveSosAlert";
        public const string SosAlertResolved = "ReceiveSosAlertResolved";
        public const string IssueCreated = "ReceiveIssueCreated";
        public const string IssueInProgress = "ReceiveIssueInProgress";
